...
- [VS Code as an MCP host](/microsoft/vs-code/overview/) — deep dive on Microsoft's editor MCP host (four config scopes · four transports · sandbox + approval model · Windows-unsandboxed gotcha).
