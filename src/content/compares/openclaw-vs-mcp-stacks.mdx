...
> *Concrete example:* same agent answers a Slack DM at 9am, an iMessage from your partner at noon, a WhatsApp message from your accountant at 4pm. Same memory. Same personality. One daemon. ([§5 Use cases](/use-cases/))
...
OpenClaw can use MCP servers (via the `mcp` tool — see [§3.3](/connections/tools/)), so any tool you've built or installed for an MCP host can flow into OpenClaw too. Investment in MCP servers isn't lost if you adopt OpenClaw.

## Honest drawbacks of each

### OpenClaw drawbacks

See [§1.4 Honest drawbacks](/overview/honest-drawbacks/) for the full list. Highlights:
...
- [§1.1 What is OpenClaw, plainly](/overview/what-is-openclaw/) — orientation
- [§1.4 Honest drawbacks](/overview/honest-drawbacks/) — full drawback list
- [§5 Use cases](/use-cases/) — the always-on workflows that benefit OpenClaw
- [§3.3 Tools](/connections/tools/) — MCP bridge details
