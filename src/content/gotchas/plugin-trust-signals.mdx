...
This is also how we assess plugins for [§4 field notes](/openclaw/plugins/) — same checklist, applied to whatever we're writing about.
...
## How we apply this in [§4 Field notes](/openclaw/plugins/)
...
- [§6.1 Self-hosting checklist](/openclaw/security/self-hosting-checklist/) — the broader posture
- [§6.3 Practical patterns](/openclaw/security/practical-patterns/) — concrete patterns you'll see
- [§4 Plugins](/openclaw/plugins/) — field notes that apply this checklist
- [§1.4 Honest drawbacks](/openclaw/overview/honest-drawbacks/) — drawback #3 (community-vetted marketplace) is what this page works against
