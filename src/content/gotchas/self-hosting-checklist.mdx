...
Some users go further and put the whole Gateway inside a Docker container ([§2.7 Docker](/openclaw/setup/docker/)) so even `main` session is contained.
...
- [§6.2 Plugin trust signals](/openclaw/security/plugin-trust-signals/) — what we look for when sampling plugins for [§4](/openclaw/plugins/)
- [§6.3 Practical patterns](/openclaw/security/practical-patterns/) — common classes of issue you'll meet
- [§6.4 What NOT to build as an agent](/openclaw/security/what-not-to-build/) — counter-intuitive guidance
- [§1.4 Honest drawbacks](/openclaw/overview/honest-drawbacks/) — the architectural drawbacks this checklist works around
