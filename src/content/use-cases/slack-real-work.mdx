...
verificationNote: "Recipe synthesised from OpenClaw Slack channel docs + standard agentic-summary patterns. Sush has not yet wired this into a real Slack workspace; promotes to tested-by-sush when run."
