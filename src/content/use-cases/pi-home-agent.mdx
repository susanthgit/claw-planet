...
- The full Pi shopping list from [§2.6](/openclaw/setup/raspberry-pi/) (~$130 if you buy fresh)
- Hello-world ([§5.1](/openclaw/use-cases/hello-world-laptop/)) working on a laptop first — useful as a reference and fallback
- An hour and a half (most of it is OS install + Pi setup; the agent config takes 20 minutes)

## Step 1 — Build and set up the Pi

Follow [§2.6 Raspberry Pi setup](/openclaw/setup/raspberry-pi/) all the way through. By the end of that page you'll have:
...
- [§2.6 Raspberry Pi setup](/openclaw/setup/raspberry-pi/) — the underlying install
- [§5.5 Self-hosted RAG over personal docs](/openclaw/use-cases/rag-personal-docs/) (planned) — adds memory engine
- [§3.4 Models](/openclaw/connections/models/) — for the local-vs-API model decision
- [§5.1 Hello-world](/openclaw/use-cases/hello-world-laptop/) — the laptop sibling
