...
- **No notebook duplication feature** (Google docs: "this feature isn't supported yet")
- **No deleted-note recovery** ("currently no way to recover deleted notes")
- **Mobile app gaps:** no Mind Maps, some advanced source management features missing
