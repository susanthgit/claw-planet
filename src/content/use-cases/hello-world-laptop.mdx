...
verificationNote: "The recipe below is a synthesis of the canonical README install + a tiny meaningful task. Sush hasn't run it end-to-end yet; promotes to tested-by-sush with timing and screenshots when he does."
