...
Follow [§2.3 Laptop quick-start](/setup/laptop/) through step 6 (`openclaw doctor`). When you finish step 6, return here.
...
If you're curious about what exactly happened in those 5 seconds, the architecture page ([§1.3](/overview/architecture/)) walks through it in detail. Short version:
...
|---|---|
| Make the agent useful in a team chat | [§5.2 Slack agent that does real work](/use-cases/slack-real-work/) |
| Have it answer customer questions on WhatsApp | [§5.3 WhatsApp FAQ answerer](/use-cases/whatsapp-faq/) (planned) |
| Run it always-on without your laptop being open | [§5.4 Pi-hosted always-on home agent](/use-cases/pi-home-agent/) |
| Talk to it about your own documents | [§5.5 Self-hosted RAG over personal docs](/use-cases/rag-personal-docs/) (planned) |
...
- [§5.2 Slack agent that does real work](/use-cases/slack-real-work/) — builds on hello-world for a real team workflow
- [§2.3 Laptop quick-start](/setup/laptop/) — the install that this recipe assumed
- [§1.2 Concepts](/overview/concepts/) — every workspace file explained
