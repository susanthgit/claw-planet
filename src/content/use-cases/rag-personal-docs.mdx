...
An agent you can ask questions like *"What did we discuss in the April retro?"* or *"What's the open question I noted in the Friday meeting?"* — and it pulls the answer from your personal markdown notes. About 75 minutes assuming hello-world ([§5.1](/openclaw/use-cases/hello-world-laptop/)) is working.
...
```bash
# Hosted (default)
# already configured: agents.defaults.model = "anthropic/claude-sonnet-4-6"
...
- [§3.5 Memory](/openclaw/connections/memory/) — full QMD docs link
- [§5.4 Pi-hosted home agent](/openclaw/use-cases/pi-home-agent/) — pair with this for "RAG on Pi"
- [§5.1 Hello-world](/openclaw/use-cases/hello-world-laptop/) — the baseline this assumes
- [§6.3 Practical patterns → memory poisoning](/openclaw/security/practical-patterns/) — RAG-specific risk
