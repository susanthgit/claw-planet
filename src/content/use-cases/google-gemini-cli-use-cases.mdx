...
Compare with Claude Code (no free tier) and Codex CLI (one-off $5 in API credits): for tinkerers and learners, Gemini CLI is the lowest-friction starting point.
