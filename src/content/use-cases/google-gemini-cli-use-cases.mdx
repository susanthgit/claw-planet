...
Where the smaller-context tools (Claude Code at 1M, Copilot CLI at 128K) need careful file selection, Gemini's 1M-token window means you can ask broad cross-cutting questions and let the agent pull in whatever it needs:
