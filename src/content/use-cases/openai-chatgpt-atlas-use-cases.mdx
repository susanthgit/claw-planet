...
**Watch for:** the memory-based privacy concerns (covered in [§ATLAS.1](/openai/chatgpt-atlas/overview/)). Memory can be cleared or paused in Settings, but stored summaries persist on OpenAI's side for up to 7 days per the current data-controls documentation.
