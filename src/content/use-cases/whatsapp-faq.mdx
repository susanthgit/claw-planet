...
A WhatsApp number that, when customers message it, **answers their FAQ in plain language using your knowledge base** — and remembers past customers so repeat questions get answered with continuity. About 90 minutes if you've got hello-world ([§5.1](/openclaw/use-cases/hello-world-laptop/)) running.
...
- Hello-world working ([§5.1](/openclaw/use-cases/hello-world-laptop/))
...
1. **Sandbox is on for non-main sessions** ([§6.1 check 4](/openclaw/security/self-hosting-checklist/)). Public input → adversarial-input-likely.
...
For a slightly more sophisticated setup, use **QMD memory** ([§3.5](/openclaw/connections/memory/)) — it indexes the markdown semantically so the agent finds the right answer faster:
...
- [§5.2 Slack agent that does real work](/openclaw/use-cases/slack-real-work/) — internal-team analogue of this
- [§5.5 RAG over personal docs](/openclaw/use-cases/rag-personal-docs/) (planned) — same shape, but for personal knowledge base
- [§3.5 Memory](/openclaw/connections/memory/) — for the QMD setup
- [§6.1 Self-hosting checklist](/openclaw/security/self-hosting-checklist/) — public-DM-bot hardening
