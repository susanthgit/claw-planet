...
1. **The licence + billing setup.** Getting a tenant to a state where you can publish (prepaid pack OR PAYG policy + maker licence + Power Platform environment) takes the longest, and varies with tenant configuration.
