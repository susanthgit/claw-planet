...
- Workspace bootstrap files (SOUL.md, AGENTS.md, USER.md, etc. — see [§1.2 Concepts](/overview/concepts/concepts/))
...
The simplest engine. Memory lives in the workspace, mainly inside **AGENTS.md** (which the runtime treats as "operating instructions + memory" — see [§1.2 Concepts](/overview/concepts/concepts/)).
...
- [§1.2 Concepts](/overview/concepts/concepts/) — workspace files (where built-in memory lives) and compaction
