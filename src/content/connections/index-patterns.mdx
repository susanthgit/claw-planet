...
### [§3.2 Channels](/openclaw/connections/channels/)
...
### [§3.3 Tools](/openclaw/connections/tools/)
...
When [§4 Plugins](/openclaw/plugins/) ships individual field notes, each one will declare its category from §3.
...
- [§3.2 Channels](/openclaw/connections/channels/) — the most-asked-about category
- [§4 Plugins](/openclaw/plugins/) — specific package field notes
- [§1.2 Concepts](/openclaw/overview/concepts/) — every term in §3 with sources
