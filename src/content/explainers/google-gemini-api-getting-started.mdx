...
> **Security note:** Google has flagged plans to enforce API-key restrictions during 2026 (unrestricted keys will be blocked). Restrict your keys to "Gemini API only" in AI Studio or the Cloud Console now to avoid surprises. Check the [API key docs](https://ai.google.dev/gemini-api/docs/api-key) for the current enforcement timeline.
