...
OpenClaw connects to a *lot* of channels — see [§3.2 Channels](/connections/channels/) for the full catalog. The official list as of last review:
...
> *Why this matters:* the default ("tools run on host for `main` session") is fine when it's just you. The moment you let other people DM your agent — friends, colleagues, group chats — you want non-main sessions sandboxed. See [§6 Security](/security/).
