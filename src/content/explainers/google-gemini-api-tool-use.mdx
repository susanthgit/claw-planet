...
> **Pricing:** **5,000 grounded prompts per month free** (shared across Gemini 3 models), then **$14 per 1,000 search queries**. A single prompt can issue multiple search queries — check `web_search_queries` to know how many were billed for that response.
