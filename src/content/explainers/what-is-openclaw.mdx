...
3. **The workspace is a directory of plain markdown files.** [SOUL.md](/openclaw/overview/concepts/#soul-md) is its personality, [AGENTS.md](/openclaw/overview/concepts/#agents-md) is its operating instructions, [USER.md](/openclaw/overview/concepts/#user-md) is what it knows about you, and so on. You can edit them with `vim`. You can put them in a git repo. They're injected into the system prompt every time the agent starts a session.
...
Setup pages like [§2.3 Laptop quick-start](/openclaw/setup/laptop/) carry the same honesty: each declares whether we've actually executed the install or only sourced it from documentation. When that flips from `sourced` to `tested` the page says so, with a date.

## What to read next

| You're trying to | Go to |
|---|---|
| Understand the canonical config files (SOUL.md, AGENTS.md, etc.) | [§1.2 Concepts & glossary](/openclaw/overview/concepts/) |
| See how the pieces fit together visually | [§1.3 Architecture diagram](/openclaw/overview/architecture/) |
| Know what OpenClaw is *not* great at | [§1.4 Honest drawbacks](/openclaw/overview/honest-drawbacks/) |
| Install it on your laptop today | [§2.3 Laptop quick-start](/openclaw/setup/laptop/) |
| Browse the channels (Slack, WhatsApp, etc.) you can connect | [§3.2 Channels](/openclaw/connections/channels/) |
