...
Per the official docs, the SDK ships nine core concepts (Handoffs and Agents-as-tools are listed as a single combined concept in the README, then expanded into a pair when you use them):
...
| **Tools** | Functions, MCP servers, or OpenAI-hosted tools (web search, code interpreter, computer use). |
