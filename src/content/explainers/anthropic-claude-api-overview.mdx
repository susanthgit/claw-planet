...
| Place | What you need |
|---|---|
| Direct (api.anthropic.com) | API key from [platform.claude.com](https://platform.claude.com) |
...
Anthropic ships **official SDKs** for Python, TypeScript/JavaScript, Java, Go, Ruby, C#/.NET, and PHP, plus an official CLI. All are listed at [docs.anthropic.com/en/api/client-sdks](https://docs.anthropic.com/en/api/client-sdks).

- **Python:** `pip install anthropic`. Sync + async clients, streaming, file uploads, message batches.
- **TypeScript / JavaScript:** `npm install @anthropic-ai/sdk`. Same surface, Node + Deno compatible.
