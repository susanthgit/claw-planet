...
- **From 19 June 2026: unrestricted API keys will be blocked.** You must restrict each key to "Gemini API only" via AI Studio or the Cloud Console. Restrict your keys now.
