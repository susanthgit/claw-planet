...
- **An Anthropic API key with access to a Computer Use-capable model** (Sonnet 4.6 or Opus 4.7 at time of writing — verify at [docs.anthropic.com](https://docs.anthropic.com))
