...
**Spec:** [a2a-protocol.org/latest/specification](https://a2a-protocol.org/latest/specification/). Repo: [github.com/a2aproject/A2A](https://github.com/a2aproject/A2A) (originally `github.com/google-a2a/A2A` — donated to the Linux Foundation).
