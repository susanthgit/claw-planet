...
This is a representative subset — see the canonical reference at [developers.openai.com/apps-sdk/reference](https://developers.openai.com/apps-sdk/reference) for the complete list (`theme`, `locale`, `displayMode`, `openExternal`, `notifyIntrinsicHeight`, and others).
