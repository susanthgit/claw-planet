...
**This is beta.** Many Claude 4.x models support Computer Use across two beta header versions — see [§API.3 Models](/anthropic/claude-api/models/) for the current model matrix. Capability is real for narrow use cases; failure modes are loud for most things. Don't put it in front of customers; do experiment with it for personal automation.
