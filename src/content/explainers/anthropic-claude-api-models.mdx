...
- **Wider context window** — the current Opus and Sonnet tiers (Opus 4.7, Sonnet 4.6, and the older 4.x Opus/Sonnet models in the table below) ship with 1M-token context; Haiku 4.5 remains at 200K
...
| **claude-sonnet-4-5** | Previous Sonnet · still active · legacy | 1M | Yes | Yes (beta) |
